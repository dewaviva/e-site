...
export const Route = createFileRoute('/products/$productid')({
  head: ({ params }) => {
    ...
    return buildSeoMeta({
      ...
      amphtml: getAmpUrlForProduct(product.id),
      schema: [
        {
        ...
        },
        {
          ...
          itemListElement: [
            ...
            },
            {
              ...
              item: `${SITE_URL}/?cat=${encodeURIComponent(product.category)}`,
            },
            {
              '@type': 'ListItem',
              position: 3,
            ...
            {activeTab === 'shipping' && (
              <div className="space-y-4 text-xs text-slate-300 max-w-2xl leading-relaxed">
                <h3 className="text-base font-bold text-white">
                  Informasi Pengiriman &amp; Kebijakan Garansi
                </h3>

                <div className="p-4 rounded-2xl bg-slate-950/80 border border-slate-800 space-y-2">
                  <h4 className="font-bold text-amber-400 flex items-center gap-2">
                    <Truck className="w-4 h-4" /> Pengiriman Reguler &amp; Instant
                  </h4>
                  <p>
                    Pesanan yang dikonfirmasi sebelum pukul 15.00 WIB akan dikirim pada hari yang sama. Kami bekerja sama dengan ekspedisi resmi (JNE, SiCepat, GoSend/GrabExpress).
                  </p>
                </div>

                <div className="p-4 rounded-2xl bg-slate-950/80 border border-slate-800 space-y-2">
                  <h4 className="font-bold text-emerald-400 flex items-center gap-2">
                    <ShieldCheck className="w-4 h-4" /> Ketentuan Garansi Resmi Kinetix
                  </h4>
                  <p>
                    Produk dilindungi Garansi Resmi Kinetix selama 24 bulan sejak tanggal pembelian. Klaim garansi dapat dilakukan melalui Pusat Layanan Pelanggan dengan menyertakan nomor pesanan.
                  </p>
                </div>
              </div>
            )}
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
        <div className="space-y-6">
          <div>
            ...
            <p className="text-xs text-slate-400">
              Lengkapi ekosistem peralatan gaya hidup Anda dengan rekomendasi berikut.
            </p>
          </div>
